class Serializable {
	...
	serialize() {
		...
		Serializable.map.set(Serializable.serialNumber, [this.constructor.name, this.stringFromObject(this)]);
	...
	wakeFrom(serial) {
		...
		if (
			this.constructor.name === objectNameInMap
		) { 
			return this.createObject(this.constructor.name, objectStringinMap)
		}else{
			throw new Error(`The serial No ${serial} does not belong to the instanciated class`)
		}
	}
...
console.log(newUser4.printInfo()); // undefined. Doe - 5949357, 2001-04-09T00:00:00.000Z
...
console.log(resurrectedNewUser4.printInfo()); //J. Doe - 5949357, 2001-04-09T00:00:00.000Z
...
console.log(newUser5.printInfo()); // undefined. Doe - 5949357, 2001-04-09T00:00:00.000Z
...
console.log(resurrectedNewUser5.printInfo()); //J. Doe - 5949357, 2001-04-09T00:00:00.000Z
