...
describe("Calculator UTILS fn test", () => {
	test("BACKSPACE: Delete last character with backspace", () => {
	...
	test("ISEMPTY: isEmpty must return TRUE if string is empty", () => {
...
describe("Calculator RESOLVE fn test", () => {
	test("Resolve correct operation", () => {
	...
	test("Resolve first character as sign", () => {
		expect(resolve("+10+10+2")).toEqual(22);
	...
	test("Resolve last character as sign", () => {
		expect(resolve("10-")).toEqual(10);
	...
	test("Resolve first and last character as sign", () => {
	...
	test("Resolve with previous resolution", () => {
