...
class Serializable {
    serialize() {
        ...
        for (let i=0; i < objEntries.length; i++) {
            if (objEntries[i][1] instanceof Date) { specialVariables["dates"].push(objEntries[i][0]) }
...
class UserDTO extends Serializable {
    constructor({ firstName, lastName, phone, birth, age, money, wants, 
                  hasDog, favouriteNumber, nan, shoppingList, superpowers } = {}) {
      super();
